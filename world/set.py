...
def do_set_speed(self,obj,value):
    if (errors.error_on_console(self,obj)):
        ...
        elif(value >= 0.0 and obj.db.move["in"] < 1.0 and obj.db.move["in"] > obj.db.engine["impulse_max"]):
            obj.db.move["in"] = obj.db.engine["impulse_max"]
        elif(value <= -1.0 and obj.db.move["in"] > -1.0 and obj.db.move["in"] < (-obj.db.engine["impulse_max"] / 2.0)):
