...
def exit_empire(self):
    alerts.console_message(self,["helm"],alerts.ansi_alert("Exiting " + self.db.move["empire"] + " space"))

def enter_empire(self):
    alerts.console_message(self,["helm"],alerts.ansi_warn("Entering " + self.db.move["empire"] + " space"))
